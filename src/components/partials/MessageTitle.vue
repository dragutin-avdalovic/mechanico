<template>
  <div>
    ...
    <el-row type="flex" justify="center" class="row-header sender">
      <el-col :span="4">
        <div class="profile-picture"><img src="../../assets/images/img_avatar2.png" alt=""></div>
      </el-col>
      <el-col :span="12">
    ...
    <el-row class="row-header" justify="center">
      <el-col :span="24">
          ...
          Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span></div>
      </el-col>
      <el-col :span="24">
        <div class="message-container"><button>Reply</button></div>
      </el-col>
    </el-row>
  </div>
</template>
